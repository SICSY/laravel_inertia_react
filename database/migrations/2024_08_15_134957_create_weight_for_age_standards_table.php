...
class CreateWeightForAgeStandardsTable extends Migration
{
    public function up()
    {
        Schema::create('weight_for_age_standards', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('weight_for_age_standards');
    }
}
